import { App, Editor, MarkdownView, Modal, Notice, Plugin, PluginSettingTab, Setting, MarkdownRenderer, Component, TFile, loadMathJax } from 'obsidian';
...
const DEFAULT_SETTINGS: WypstSettings = {
	mySetting: 'default'
}
...
export default class Wypst extends Plugin {
	...
	async onload() {
		...
		global.MathJax.tex2chtml = (e, r) => {
			const renderedString = wypst.renderToString(e, {displayMode: r.display});
